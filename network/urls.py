...
urlpatterns = [
    ...
    path("comment/<int:post_id>/", views.create_or_edit_comment, name="create_comment"),
    path("comment/edit/<int:comment_id>/", views.create_or_edit_comment, name="edit_comment"),
